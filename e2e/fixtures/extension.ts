 ...
 * 辅助函数：创建新的 Popup 页面
 */
export async function createPopupPage(context: BrowserContext, extensionId: string): Promise<Page> {
 ...
 */
export async function createOptionsPage(context: BrowserContext, extensionId: string): Promise<Page> {
  const page = await context.newPage();
